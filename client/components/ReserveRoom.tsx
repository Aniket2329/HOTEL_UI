...
export default function ReserveRoom({ onBack }: ReserveRoomProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        setSuccess(
          `Reservation created successfully! Reservation ID: ${response.reservation?.id}`,
        );
        setFormData({
          guestName: "",
          guestEmail: "",
  ...
  const getAmenityIcon = (amenity: string) => {
    switch (amenity.toLowerCase()) {
      ...
      case "ac":
        return <Car className="h-4 w-4" />; // Using car as a placeholder for AC
      default:
            ...
            {!selectedRoom ? (
              <Card>
                <CardContent className="text-center py-16">
                  ...
                  <p className="text-slate-500 dark:text-slate-400">
                    Choose a room from the available options to start your
                    reservation.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    Room - {formatCurrency(selectedRoom.price)}/night
                  </CardDescription>
                </CardHeader>
